...
const BIOMES = {
  forest: {
    name: 'Foresta',
    gridColor: 0x0282ff,    gridAlpha: 0.055,
    bigGridColor: 0x0282ff, bigGridAlpha: 0.10,
    decoColor: 0x4488ff,     decoRingColor: 0x0088ff,
    canvasColor: 0x060810,
    rockTint: 0xffffff,     obstacleDensity: 1.0,
  ...
  desert: {
    name: 'Deserto',
    gridColor: 0xffaa22,    gridAlpha: 0.04,
    bigGridColor: 0xff8800, bigGridAlpha: 0.08,
    decoColor: 0xddaa44,    decoRingColor: 0xcc8833,
    canvasColor: 0x1a1008,
    rockTint: 0xddaa66,     obstacleDensity: 0.6,
    enemySlime: 1,           enemyBigSlime: 2,
  ...
  ice: {
    name: 'Ghiaccio',
    gridColor: 0x66ccff,    gridAlpha: 0.06,
    bigGridColor: 0x88ddff, bigGridAlpha: 0.10,
    decoColor: 0xaaddff,    decoRingColor: 0x88bbdd,
    canvasColor: 0x080c14,
    rockTint: 0xaaccee,     obstacleDensity: 0.8,
    enemySlime: 1,           enemyBigSlime: 2,
  ...
  swamp: {
    name: 'Palude',
    gridColor: 0x44aa44,    gridAlpha: 0.05,
    bigGridColor: 0x338833, bigGridAlpha: 0.09,
    decoColor: 0x66cc66,    decoRingColor: 0x448844,
    canvasColor: 0x0a1008,
    rockTint: 0x558844,     obstacleDensity: 1.2,
